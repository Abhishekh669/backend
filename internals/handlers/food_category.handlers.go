...
func (h *FoodCategoryHandler) UpdateMenuItemHandler(c *gin.Context) {
...
func (h *FoodCategoryHandler) UpdateCategoryHandler(c *gin.Context) {
...
func (h *FoodCategoryHandler) DeleteCategoriesHandler(c *gin.Context) {
...
func (h *FoodCategoryHandler) CreateMenuItemsHandlers(c *gin.Context) {
